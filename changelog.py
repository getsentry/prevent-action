...
def update_changelog():
    ...
    for commit in commits:
        ...
        changelog.append(
            f"* {commit_details['title']} by @{commit_details['author']['login']} in {commit_details['url']}"
        )

    changelog.append("\n")
    changelog.append(
        f"**Full Changelog**: https://github.com/getsentry/sentry-prevent-action/compare/{previous}..v{version}\n"
    )
